...
class TestStart(unittest.TestCase):
    ...
    def test_5_and_6(self):
        ...
        self.assertEqual(self.dict.list_of_5_6(), "5 and 6 have: []")

    def test_average_score(self):
        self.assertEqual(self.just_dict.average_score(), "Students pretend for auto: ['Ivan B.A', 7.4,"
                                                         " 'Ivan G.Z', 7.4]")
        self.assertEqual(self.one_stud_dict.average_score(), "Students pretend for auto: []")
    ...
    def test_group_number(self):
        ...
        self.assertEqual(self.just_dict.check_by_group(3),
                         "In This group 3: []")
